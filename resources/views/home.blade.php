...
<section id="about" class="about">
    ...
    <div class="container">
        <h2>Tutorial</h2>
        <div class="container container-tutorial justify-content-center">
            {{-- <div class="col"> --}}
                <div class="card card-tutorial">
                  <img src="{{asset('img/tutorial1.PNG')}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Pertama, Registrasi akun terlebih dahulu.</p>
                  </div>
                </div>
                <div class="card card-tutorial">
                  <img src="{{asset('img/tutorial2.PNG')}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Kedua, Silahkan login dengan akun yang sudah anda dibuat.</p>
                  </div>
                </div>
                <div class="card card-tutorial">
                  <img src="{{asset('img/tutorial3.PNG')}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Ketiga, Klik tombol "Buat Resume CV"</p>
                  </div>
                </div>
                <div class="card card-tutorial">
                  <img src="{{asset('img/4.PNG')}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Keempat, Masukkan data dengan sesuai, untuk dijadikan resume cv anda.</p>
                  </div>
                </div>
                <div class="card card-tutorial">
                  <img src="{{asset('img/tutorial5.PNG')}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Selamat Resume CV telah berhasil anda buat dengan mudah !</p>
                  </div>
                </div>
            {{-- </div> --}}
            {{-- <div class="card card-tutorial">A</div>
            <div class="card card-tutorial">B</div>
            <div class="card card-tutorial">C</div>
            <div class="card card-tutorial">D</div>
            <div class="card card-tutorial">E</div> --}}
        </div>
    </div>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFF" fill-opacity="1" d="M0,128L48,154.7C96,181,192,235,288,229.3C384,224,480,160,576,165.3C672,171,768,245,864,245.3C960,245,1056,171,1152,133.3C1248,96,1344,96,1392,96L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
</section>
