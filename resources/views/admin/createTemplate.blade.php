...
<form method="POST" action="{{route('templates.store')}}" class="mt-4" enctype="multipart/form-data">
    @csrf
      <div class="col-md-6 mb-3">
          <label for="name" class="form-label fw-semibold">Nama Template</label>
          <input type="text" name="nama_template" class="form-control @error('nama_template') is-invalid @enderror" id="name" value="{{ old('nama_template') }}">
          @error('nama_template')
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="text" name="keterangan_template" class="form-control @error('keterangan_template') is-invalid @enderror" id="keterangan_template" value="{{ old('keterangan_template') }}">
      ...
      {{-- <div class="col-md-6 mb-3">
        ...
        <div class="col-md-8 mb-4">
          ...
          <textarea class="form-control @error('design_html_css') is-invalid @enderror" id="design_html_css" name="design_html_css" rows="20">{{ old('design_html_css') }}</textarea>
